...
{
    public class BL10CookieAuthProvider : AuthenticationStateProvider
    {
        private readonly HttpClient _httpClient;
        private readonly ILocalStorageService _localStorage;
        private readonly ICookieAccessor _cookieStorage;

        private string __CookieName = "__BLSESSION__";

        public BL10CookieAuthProvider(
            HttpClient httpClient,
            ICookieAccessor cookieStorage)
        {
        ...
        public override async Task<AuthenticationState> GetAuthenticationStateAsync()
        {
            ...
            var savedToken = await _cookieStorage.GetValueAsync("__session__");
