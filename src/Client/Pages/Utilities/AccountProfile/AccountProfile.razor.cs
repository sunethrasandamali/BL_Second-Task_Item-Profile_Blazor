...
using BlueLotus360.Com.Client.Pages.Utilities.AccountProfile.Components;
...
namespace BlueLotus360.Com.Client.Pages.Utilities.AccountProfile
{
    public partial class AccountProfile
    {
        ...
        private void HookInteractions()
        {
            ...
            AppSettings.RefreshTopBar("Acount Profile Simple");
        ...
        private async Task ShowRecord(int id)
        {

            Showtable = false;
            ShowRecordItems = true;

            accountProfileResponse = gridDetails.Where(x => x.AccountKey == id).FirstOrDefault();
