...
using BlueLotus360.Com.Client.Shared.Dialogs.Chart.Finance;
...
namespace BlueLotus360.Com.Client.Pages.DashBoard
{
    public partial class FinanceDashBoard
    {
        ...
        //   // await SetValue("BUCombo", request.BusinessUnit);
        //}
        ...
        private async Task OnClickChartAsync()
        {
            if (!_dashboardManager.IsExceptionthrown())
            {
                ...
                var dialog = _dialogService.Show<Monthly_GPft_NETPft_DT>("", parameters, options);
