...
using BlueLotus360.Com.Infrastructure.Managers.Misc.Document;
using BlueLotus360.Com.Infrastructure.Managers.Misc.DocumentType;

namespace BlueLotus360.Com.Client.Pages.Misc
{
