...
{
    [Parameter]
    public MenuItem Menus { get; set; } = new();
    public IDictionary<string, string> icon_dict;
    protected  override async Task OnInitializedAsync()
	{
        icon_dict = new Dictionary<string, string>();
    ...
    private void SetIcon(IList<MenuItem> list)
    {
        ...
        {
            icon_dict[itm.Menuname] = GetIconByStringName(itm.MenuIcon, typeof(Icons));
