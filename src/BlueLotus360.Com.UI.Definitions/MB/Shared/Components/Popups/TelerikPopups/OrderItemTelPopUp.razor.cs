...
{
    public partial class OrderItemTelPopUp
    {
        [Parameter]
        ...
        {
            Validaor = new SalesOrderValidator(new Order() { OrderLocation = ParentLocation, SelectedOrderItem = OrderItem, IsFromQuotation = IsQuotation });
            if (Validaor != null)
            {
