...
{
    public partial class BLImageBox : IBLUIOperationHelper
    {
        ...
        protected override void OnInitialized()
        {
            ...
            Base64ImageSource = displayValue;
        ...
        {
            this.Base64ImageSource = string.Empty;
            __forcerender = true;
        ...
        public  async Task Refresh()
        {
            ...
            {
                this.Base64ImageSource = propertyConversion.Value;// get value of property 
        ...
        {
            this.Base64ImageSource = value.ToString();
            StateHasChanged();
            await Task.CompletedTask;
        }
    }
